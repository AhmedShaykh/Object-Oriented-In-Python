...
obj1 : Teacher = Teacher(1450, "Sir Zia Khan"); # Create New Object Then Increase The Value Of Counter
...
obj2 : Teacher = Teacher(2345, "Sir Qasim");
...
obj3: Teacher = Teacher(3573, "Sir Adil");
